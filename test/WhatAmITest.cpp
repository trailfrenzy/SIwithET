...
class WhatAmITest : public ::testing::Test //CppUnit::TestFixture
{
public:
	WhatAmITest() {}
	virtual ~WhatAmITest() {}
...
TEST_F(WhatAmITest, TestWithOneDim) {
//	EXPECT_EQ(pFib->size(), 3);
//}
//
//void TestWithOneDim()
//   {
   ...
   /// @see TestWithTwoDim()
	...
	TEST_F(WhatAmITest, TestWithTwoDim)
	{
...
TEST_F(WhatAmITest, TestMultipleDim)
{
