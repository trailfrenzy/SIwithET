#pragma once
#ifndef METRIC_BASE_UNITS_SUBSTANCE_INCLUDE_H
#define METRIC_BASE_UNITS_SUBSTANCE_INCLUDE_H
#include "Struct_Symbol.h"

namespace Metric {
    namespace AtomicUnit
    {
        struct Mole : SystemOfUnits::Substance
        {
            enum : bool { IsBase = true };
            constexpr static char const* str() noexcept { return "mole"; }
...
#endif // !METRIC_BASE_UNITS_SUBSTANCE_INCLUDE_H
